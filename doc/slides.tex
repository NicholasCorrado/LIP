...
\begin{figure}
  \centering
  \includegraphics[height=0.5\textheight,keepaspectratio]{star-schema}
\end{figure}
...
\begin{frame}
  ...
  \begin{tikzpicture}
  \centering
    \node<1> (img1) {\includegraphics[height=0.7\textheight,keepaspectratio]{skew-table.png}};
    \node<2> (img2) {\includegraphics[height=0.7\textheight,keepaspectratio]{time-graph-lip-hash.png}};
    \node<3-> (img3) {\includegraphics[height=0.7\textheight,keepaspectratio]{time-graph-lip-lipk.png}};
  \end{tikzpicture}
  \begin{itemize}
  \pause
  \pause
  \pause
      \item LIP-$k$ performs better than LIP on some queries...
      \pause
